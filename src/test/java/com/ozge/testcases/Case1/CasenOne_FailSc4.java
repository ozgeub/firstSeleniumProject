...
public class CasenOne_FailSc4 implements BrowserController, NavigationController {
    ...
    @Test
    // unsubscriber user
    public void loginCases4() throws InterruptedException {

    closeFirstPopUp(PageObjects.popupContainer, PageObjects.popupContainerClose);
    waitForLoad();
    navigateloginPopup();

    sendKeys(PageObjects.emailTextBox, "ozgeuysal@hotmail.com");
    sendKeys(PageObjects.passwordTxtBox, "1111");
    waitAndClick(PageObjects.loginSubmit);
    waitForElementAppeared(PageObjects.loginErrorPth);
        Assert.assertEquals(rtrnText(PageObjects.loginErrorPth),PageObjects.loginErrorMsg2);
